...
<body style="background-color: #9dc8e2">
    ...
    <div class="tab-content">
        ...
        <div id="signup" class="tab-pane">
            <form action="FileUploadDBSer" class="form-signin" method="post" enctype="multipart/form-data">
                <p class="text-muted text-center btn-block btn btn-primary btn-rect">Please Fill Details To Register</p>
                <input type="text" placeholder="Your Name" name="uname" title="name format" pattern="[a-zA-Z]{2,20}" required="" class="form-control" />
